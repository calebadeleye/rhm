...
/** Defensively normalises our own backend's /api/schedule response. The
 * backend already strips admin fields and validates shape, but we treat
 * every network boundary the same way: never trust it blindly. */
